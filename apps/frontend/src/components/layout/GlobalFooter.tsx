  ...
  return (
    <footer className="w-full bg-transparent dark:bg-slate-900 border-t border-[#E5E8EE] dark:border-slate-800 px-6 sm:px-8 py-8 mt-auto transition-colors duration-200">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Col 2: Policies */}
        <div className="flex flex-col gap-3">
          <h5 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider">Chính sách</h5>
          <ul className="flex flex-col gap-2.5 text-xs text-slate-500 dark:text-slate-400">
            <li><a className="hover:text-[#008FD5] dark:hover:text-sky-400 transition-colors" href="#chinh-sach-bao-mat">Chính sách bảo mật</a></li>
            <li><a className="hover:text-[#008FD5] dark:hover:text-sky-400 transition-colors" href="#dieu-khoan-su-dung">Điều khoản sử dụng</a></li>
            <li><a className="hover:text-[#008FD5] dark:hover:text-sky-400 transition-colors" href="#quy-dinh-hoc-tap">Quy định học tập & chứng chỉ</a></li>
          </ul>
        </div>
        
        {/* Col 3: Contact */}
        <div className="flex flex-col gap-3">
          <h5 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider">Liên hệ</h5>
          <ul className="flex flex-col gap-2.5 text-xs text-slate-500 dark:text-slate-400">
            <li>
